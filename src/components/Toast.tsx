...
function Toast({
  ...
  return (
    ...
    >
      <Text className="font-bold text-base text-left text-foreground">{message}</Text>
      {showProgress && (
        <View className="mt-2 rounded">
          <Animated.View
            className={`${toastBarVariants[variant]} h-2 opacity-50 rounded`}
            style={{
